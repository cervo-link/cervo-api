...
describe('deleteWorkspace', () => {
  it('should delete a workspace', async () => {
    ...
    const result = await deleteWorkspace(workspace.id, owner.id)
  ...
  it('should return 404 when workspace does not exist', async () => {
    ...
    const result = await deleteWorkspace(randomUUID(), owner.id)
  ...
  it('should return 403 when requester is not the owner', async () => {
    ...
    const result = await deleteWorkspace(workspace.id, other.id)
